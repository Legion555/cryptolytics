...
const Search = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-evenly gap-5 md:gap-10">
            <div className="w-full h-48 md:h-64 xl:h-80 flex flex-col justify-center items-center gap-2 py-2 rounded-xl shadow bg-gray-900">
                <div>
            ...
            <div className="w-full h-64 xl:h-80 flex flex-col justify-center items-center py-2 rounded-xl shadow bg-gray-900">
